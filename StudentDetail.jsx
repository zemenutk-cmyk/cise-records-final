...
import { Pencil, Archive, ArrowLeft, Download } from 'lucide-react'
...
export default function StudentDetail() {
  ...
  async function handleDownload() {
    await addAuditLog({
      userId: user.id, username: user.username, action: 'EXPORT',
      targetType: 'student', targetId: id,
      details: `Exported record for ${student.firstName} ${student.lastName} to CSV`,
    })
    exportStudentsToCSV([student])
  }
      ...
      <div className="bg-white rounded-xl border p-5 space-y-4">
        <div className="flex justify-between items-start">
          ...
          <div className="flex gap-2">
            <button onClick={handleDownload} className="p-2 rounded-lg bg-red-50 text-cise-red hover:bg-red-100">
              <Download size={16} />
            </button>
